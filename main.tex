...
\title{Dense Semantic Segmentation for Biomedical Electron Microscopy} % Poster title
...
\begin{column}{\onecolwid}
    ...
    \begin{tcolorbox}[title=Introduction]
        \begin{itemize}
            ...
            \item Lack of \emph{3D benchmark datasets} greatly hinders vision research.  %\emph{Instance} segmentation: Assign a unique tag to each object in an image. %the partitioning of an image into labeled regions corresponding to image content.
    ...
    \begin{tcolorbox}[title=Segmentation Challenges]
        \begin{itemize}
            ...
            \item Lack of \emph{3D benchmark datasets} makes it hard to compare results and determine current sota.  %Different EM hardware + sample combinations create \emph{many image types}.
            ...
            \item \textbf{Goal}: Release a high quality 3D benchmark dataset with helper tools for wide adoption. %Use that workflow to design \emph{problem-specific segmentation algorithms}.
        \end{itemize}
    \end{tcolorbox}
...
\begin{column}{\twocolwid}
    ...
    \begin{center}
        \begin{figure}
            ...
            %    \includegraphics[width=.4\linewidth]{fig/ensemble.png}
            %\end{subfigure}
            \hfill
            \begin{subfigure}{\onecolwid}
